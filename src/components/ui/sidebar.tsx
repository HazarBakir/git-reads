  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        ...
        >
          <style>{`
            /* Scrollbar customization for the sidebar (Webkit browsers) */
            ...
            [data-slot="sidebar-content"]:active::-webkit-scrollbar-thumb {
              background: #2563eb;
              box-shadow: 0 0 0 2px #60a5fa66;
            }
            [data-slot="sidebar-content"]::-webkit-scrollbar-corner {
              background: transparent;
            }
            /* Firefox */
            ...
            [data-slot="sidebar-content"]:active {
              scrollbar-color: #2563eb #60a5fa;
            }
          `}</style>
          {children}
        </div>
